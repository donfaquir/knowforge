/** 右栏顶栏：与「大纲/AI」同排右侧的会话图标（仅由 App 在 AI Tab 时挂载）。 */
...
/** 与 `FolderBulkToggleIcon` / `.file-tree__bulk-toggle-svg` 一致 */
...
/** 右栏顶栏「大纲/AI」行右侧：历史 / 新建 / 删除（仅 AI 视图由 App 挂载） */
export function AiConversationToolbar() {
  ...
  return (
    <div className="right-panel-shell__ai-toolbar" ref={anchorRef} {...dragExcludeProps}>
      <button
        type="button"
